    ...
    internal class Opdracht2
    {
        public void Opdracht2
        {
            ...
            if input == "links"{
                ...
                } Console console = Console;else if inputA == "rechts"{
        ...
        Console.WriteLine("je bevind je zich in de slaapkamer, in deze slaapkamer stonden 3 bedden, het 1st bed was te hard, het 2de bed was te zacht, en de 3de bed was een monster, die jou at. Je hebt verloren!");
    }
}
else
{
